...
The **X quick menu** is a translucent in-world control overlay for cultivation methods, technique slots and expandable cultivation utilities such as scanning/gauging settings. Future active-Qi allocations can also live there, such as:
...
Current test version: **0.1.0-alpha.16**
